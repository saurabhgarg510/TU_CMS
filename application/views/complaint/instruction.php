<section id="main" class="container" >
    ...
    <ol>
        ...
        <li>Track your complaint by clicking on 'Exisiting Complaints' </li>
        <li>By default, the status of your complaint will be changed to PENDING. This means that the caretaker is yet to view the same.</li>
