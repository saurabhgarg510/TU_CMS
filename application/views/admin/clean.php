...
<div class="box">
<form action="http://localhost/ci/index.php/admin/deleteComplaints/" method="post" id="all">
...
<form action="http://localhost/ci/index.php/admin/deleteComplaints/" method="post" id="comp">
